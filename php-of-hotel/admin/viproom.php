...
<div class="roomtype"><b><?php echo $indexpage->viproom ?></b></div>
<a href="viproompic.php"><div class="roomimg"><img width="540px" height="200px" class="bor" src="images/<?php echo $indexpage->vimg ?>" />
</div></a>
<div class="fac">
