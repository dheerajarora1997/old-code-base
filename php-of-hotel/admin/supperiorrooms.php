...
<title>::SUPPERIOR DOUBLE ROOMS::</title>
...
<div class="roomtype"><b>SUPPERIOR DOUBLE ROOMS</b></div>
<a href="supperiordoubleroompic.php"><div class="roomimg"><img width="540px" height="200px" class="bor" src="images/<?php echo $indexpage->sudrimg ?>" />
</div></a>
<div class="fac">
...
<div class="book"> Arrival Date <input style="background-color:#bbbbbb" name="adate" class="bor1" type="date"> Departure Date <input style="background-color:#bbbbbb" class="bor1" type="date" name="ddate"> <input style="background-color:#cf822f" type="submit"  class="bor1" name="book" value="BOOK" ></div>
-->
</form>
<div class="images">
<h2>REVIEWS</h2>
